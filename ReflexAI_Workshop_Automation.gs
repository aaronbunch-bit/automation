  ...
  ui.createMenu('ReflexAI Scheduling')
    .addSubMenu(
      ui.createMenu('Send Offers')
        ...
        .addSubMenu(
          ui.createMenu('Send Next Week Offers')
            .addItem('All Supergroups', 'runWeeklyAssignedSchedulingAllSupergroups')
            .addItem('Adult Learning', 'runWeeklyAssignedSchedulingAdultLearning')
            .addItem('College', 'runWeeklyAssignedSchedulingCollege')
            .addItem('ELD', 'runWeeklyAssignedSchedulingELD')
            .addItem('High School', 'runWeeklyAssignedSchedulingHighSchool')
            .addItem('Prof Certs', 'runWeeklyAssignedSchedulingProfCerts')
        )
        .addSubMenu(
          ui.createMenu('Send Current Week Offers')
            .addItem('All Supergroups', 'runCurrentWeeklyAssignedSchedulingAllSupergroups')
            .addItem('Adult Learning', 'runCurrentWeeklyAssignedSchedulingAdultLearning')
            .addItem('College', 'runCurrentWeeklyAssignedSchedulingCollege')
            .addItem('ELD', 'runCurrentWeeklyAssignedSchedulingELD')
            .addItem('High School', 'runCurrentWeeklyAssignedSchedulingHighSchool')
            .addItem('Prof Certs', 'runCurrentWeeklyAssignedSchedulingProfCerts')
        )
        .addSeparator()
